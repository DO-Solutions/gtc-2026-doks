output "vpc_id" {
  ...
  value       = digitalocean_vpc.gtc.id
}

output "cluster_id" {
  description = "The ID of the DOKS cluster"
  value       = digitalocean_kubernetes_cluster.gtc.id
}

output "cluster_name" {
  description = "The name of the DOKS cluster"
  value       = digitalocean_kubernetes_cluster.gtc.name
}

output "cluster_endpoint" {
  description = "The endpoint URL for the DOKS cluster API"
  value       = digitalocean_kubernetes_cluster.gtc.endpoint
}
